<template>
  <section class="terms">
    ...
    <p class="terms-updated">Last updated: December 27, 2025</p>
    ...
    <div class="terms-content">
      ...
      <ul>
        ...
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Burrito Edition.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Burrito Edition, accessible from 
          <a href="https://burritoedition.com/" target="_blank" rel="noopener">https://burritoedition.com/</a>
        </li>
        <li>
      ...
      <p>
        ...
        for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods 
      ...
      <ul>
        <li>By email: <a href="mailto:admin@burritoedition.com">admin@burritoedition.com</a></li>
      </ul>
    </div>
  </section>
</template>
